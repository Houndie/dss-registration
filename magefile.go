...
func DeployDynamic() error {
	...
	functions := []string{"PopulateForm", "AddRegistration", "ListUserRegistrations", "GetUserRegistration", "UpdateRegistration", "AddDiscount", "GetDiscount", "VolunteerExists", "InsertVolunteer"}
