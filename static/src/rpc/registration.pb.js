...
$root.dss = (function() {
    ...
    dss.Registration = (function() {
        ...
        /**
         * Callback as used by {@link dss.Registration#uploadVaxImage}.
         * @memberof dss.Registration
         * @typedef UploadVaxImageCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {dss.RegistrationUploadVaxImageRes} [response] RegistrationUploadVaxImageRes
         */

        /**
         * Calls UploadVaxImage.
         * @function uploadVaxImage
         * @memberof dss.Registration
         * @instance
         * @param {dss.IRegistrationUploadVaxImageReq} request RegistrationUploadVaxImageReq message or plain object
         * @param {dss.Registration.UploadVaxImageCallback} callback Node-style callback called with the error, if any, and RegistrationUploadVaxImageRes
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(Registration.prototype.uploadVaxImage = function uploadVaxImage(request, callback) {
            return this.rpcCall(uploadVaxImage, $root.dss.RegistrationUploadVaxImageReq, $root.dss.RegistrationUploadVaxImageRes, request, callback);
        }, "name", { value: "UploadVaxImage" });
         ...
         * @instance
         * @param {dss.IRegistrationUploadVaxImageReq} request RegistrationUploadVaxImageReq message or plain object
         * @returns {Promise<dss.RegistrationUploadVaxImageRes>} Promise
         * @variation 2
         */
    ...
    dss.RegistrationUploadVaxImageReq = (function() {
        ...
        /**
         * Properties of a RegistrationUploadVaxImageReq.
         * @memberof dss
         * @interface IRegistrationUploadVaxImageReq
         * @property {string|null} [id] RegistrationUploadVaxImageReq id
         * @property {number|Long|null} [filesize] RegistrationUploadVaxImageReq filesize
         */

        /**
         * Constructs a new RegistrationUploadVaxImageReq.
         * @memberof dss
         * @classdesc Represents a RegistrationUploadVaxImageReq.
         * @implements IRegistrationUploadVaxImageReq
         * @constructor
         * @param {dss.IRegistrationUploadVaxImageReq=} [properties] Properties to set
         */
        function RegistrationUploadVaxImageReq(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * RegistrationUploadVaxImageReq id.
         * @member {string} id
         * @memberof dss.RegistrationUploadVaxImageReq
         * @instance
         */
        RegistrationUploadVaxImageReq.prototype.id = "";

        /**
         * RegistrationUploadVaxImageReq filesize.
         * @member {number|Long} filesize
         * @memberof dss.RegistrationUploadVaxImageReq
         * @instance
         */
        RegistrationUploadVaxImageReq.prototype.filesize = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * Creates a new RegistrationUploadVaxImageReq instance using the specified properties.
         * @function create
         * @memberof dss.RegistrationUploadVaxImageReq
         * @static
         * @param {dss.IRegistrationUploadVaxImageReq=} [properties] Properties to set
         * @returns {dss.RegistrationUploadVaxImageReq} RegistrationUploadVaxImageReq instance
         */
        RegistrationUploadVaxImageReq.create = function create(properties) {
            return new RegistrationUploadVaxImageReq(properties);
        };

        /**
         * Encodes the specified RegistrationUploadVaxImageReq message. Does not implicitly {@link dss.RegistrationUploadVaxImageReq.verify|verify} messages.
         * @function encode
         * @memberof dss.RegistrationUploadVaxImageReq
         * @static
         * @param {dss.IRegistrationUploadVaxImageReq} message RegistrationUploadVaxImageReq message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        RegistrationUploadVaxImageReq.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.id != null && Object.hasOwnProperty.call(message, "id"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.id);
        ...
        /**
         * Encodes the specified RegistrationUploadVaxImageReq message, length delimited. Does not implicitly {@link dss.RegistrationUploadVaxImageReq.verify|verify} messages.
         * @function encodeDelimited
         * @memberof dss.RegistrationUploadVaxImageReq
         * @static
         * @param {dss.IRegistrationUploadVaxImageReq} message RegistrationUploadVaxImageReq message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        RegistrationUploadVaxImageReq.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a RegistrationUploadVaxImageReq message from the specified reader or buffer.
         * @function decode
         * @memberof dss.RegistrationUploadVaxImageReq
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {dss.RegistrationUploadVaxImageReq} RegistrationUploadVaxImageReq
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RegistrationUploadVaxImageReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.dss.RegistrationUploadVaxImageReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a RegistrationUploadVaxImageReq message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof dss.RegistrationUploadVaxImageReq
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RegistrationUploadVaxImageReq.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a RegistrationUploadVaxImageReq message.
         * @function verify
         * @memberof dss.RegistrationUploadVaxImageReq
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        RegistrationUploadVaxImageReq.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.id != null && message.hasOwnProperty("id"))
                if (!$util.isString(message.id))
        ...
        /**
         * Creates a RegistrationUploadVaxImageReq message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof dss.RegistrationUploadVaxImageReq
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {dss.RegistrationUploadVaxImageReq} RegistrationUploadVaxImageReq
         */
        RegistrationUploadVaxImageReq.fromObject = function fromObject(object) {
            if (object instanceof $root.dss.RegistrationUploadVaxImageReq)
                return object;
            var message = new $root.dss.RegistrationUploadVaxImageReq();
            if (object.id != null)
                message.id = String(object.id);
        ...
        /**
         * Creates a plain object from a RegistrationUploadVaxImageReq message. Also converts values to other types if specified.
         * @function toObject
         * @memberof dss.RegistrationUploadVaxImageReq
         * @static
         * @param {dss.RegistrationUploadVaxImageReq} message RegistrationUploadVaxImageReq
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        RegistrationUploadVaxImageReq.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this RegistrationUploadVaxImageReq to JSON.
         * @function toJSON
         * @memberof dss.RegistrationUploadVaxImageReq
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        RegistrationUploadVaxImageReq.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return RegistrationUploadVaxImageReq;
    })();

    dss.RegistrationUploadVaxImageRes = (function() {

        /**
         * Properties of a RegistrationUploadVaxImageRes.
         * @memberof dss
         * @interface IRegistrationUploadVaxImageRes
         * @property {string|null} [url] RegistrationUploadVaxImageRes url
         */

        /**
         * Constructs a new RegistrationUploadVaxImageRes.
         * @memberof dss
         * @classdesc Represents a RegistrationUploadVaxImageRes.
         * @implements IRegistrationUploadVaxImageRes
         * @constructor
         * @param {dss.IRegistrationUploadVaxImageRes=} [properties] Properties to set
         */
        function RegistrationUploadVaxImageRes(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * RegistrationUploadVaxImageRes url.
         * @member {string} url
         * @memberof dss.RegistrationUploadVaxImageRes
         * @instance
         */
        RegistrationUploadVaxImageRes.prototype.url = "";

        /**
         * Creates a new RegistrationUploadVaxImageRes instance using the specified properties.
         * @function create
         * @memberof dss.RegistrationUploadVaxImageRes
         * @static
         * @param {dss.IRegistrationUploadVaxImageRes=} [properties] Properties to set
         * @returns {dss.RegistrationUploadVaxImageRes} RegistrationUploadVaxImageRes instance
         */
        RegistrationUploadVaxImageRes.create = function create(properties) {
            return new RegistrationUploadVaxImageRes(properties);
        };

        /**
         * Encodes the specified RegistrationUploadVaxImageRes message. Does not implicitly {@link dss.RegistrationUploadVaxImageRes.verify|verify} messages.
         * @function encode
         * @memberof dss.RegistrationUploadVaxImageRes
         * @static
         * @param {dss.IRegistrationUploadVaxImageRes} message RegistrationUploadVaxImageRes message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        RegistrationUploadVaxImageRes.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
        ...
        /**
         * Encodes the specified RegistrationUploadVaxImageRes message, length delimited. Does not implicitly {@link dss.RegistrationUploadVaxImageRes.verify|verify} messages.
         * @function encodeDelimited
         * @memberof dss.RegistrationUploadVaxImageRes
         * @static
         * @param {dss.IRegistrationUploadVaxImageRes} message RegistrationUploadVaxImageRes message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        RegistrationUploadVaxImageRes.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a RegistrationUploadVaxImageRes message from the specified reader or buffer.
         * @function decode
         * @memberof dss.RegistrationUploadVaxImageRes
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {dss.RegistrationUploadVaxImageRes} RegistrationUploadVaxImageRes
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RegistrationUploadVaxImageRes.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.dss.RegistrationUploadVaxImageRes();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a RegistrationUploadVaxImageRes message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof dss.RegistrationUploadVaxImageRes
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RegistrationUploadVaxImageRes.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a RegistrationUploadVaxImageRes message.
         * @function verify
         * @memberof dss.RegistrationUploadVaxImageRes
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        RegistrationUploadVaxImageRes.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
        ...
        /**
         * Creates a RegistrationUploadVaxImageRes message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof dss.RegistrationUploadVaxImageRes
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {dss.RegistrationUploadVaxImageRes} RegistrationUploadVaxImageRes
         */
        RegistrationUploadVaxImageRes.fromObject = function fromObject(object) {
            if (object instanceof $root.dss.RegistrationUploadVaxImageRes)
                return object;
            var message = new $root.dss.RegistrationUploadVaxImageRes();
            if (object.url != null)
        ...
        /**
         * Creates a plain object from a RegistrationUploadVaxImageRes message. Also converts values to other types if specified.
         * @function toObject
         * @memberof dss.RegistrationUploadVaxImageRes
         * @static
         * @param {dss.RegistrationUploadVaxImageRes} message RegistrationUploadVaxImageRes
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        RegistrationUploadVaxImageRes.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this RegistrationUploadVaxImageRes to JSON.
         * @function toJSON
         * @memberof dss.RegistrationUploadVaxImageRes
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        RegistrationUploadVaxImageRes.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return RegistrationUploadVaxImageRes;
    })();
