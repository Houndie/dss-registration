...
const isPaid = (r: dss.IRegistrationInfo) => 
	((!r.fullWeekendPass || r.fullWeekendPass.paid) &&
		(!r.danceOnlyPass || r.danceOnlyPass.paid) &&
		(!r.soloJazz || r.soloJazz.paid) &&
		(!r.mixAndMatch || r.mixAndMatch.paid) &&
		(!r.teamCompetition || r.teamCompetition.paid) &&
		(!r.tshirt || r.tshirt.paid))
