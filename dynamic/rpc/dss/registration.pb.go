...
type RegistrationPricesRes struct {
	...
	WeekendPassCost     int64               `protobuf:"varint,1,opt,name=weekend_pass_cost,json=weekendPassCost,proto3" json:"weekend_pass_cost,omitempty"`
	...
	DancePassCost       int64               `protobuf:"varint,3,opt,name=dance_pass_cost,json=dancePassCost,proto3" json:"dance_pass_cost,omitempty"`
	MixAndMatchCost     int64               `protobuf:"varint,4,opt,name=mix_and_match_cost,json=mixAndMatchCost,proto3" json:"mix_and_match_cost,omitempty"`
...
func (x *RegistrationPricesRes) GetDancePassCost() int64 {
	if x != nil {
		return x.DancePassCost
	}
	return 0
}

func (x *RegistrationPricesRes) GetMixAndMatchCost() int64 {
	if x != nil {
		return x.MixAndMatchCost
	}
	return 0
}

func (x *RegistrationPricesRes) GetSoloJazzCost() int64 {
	if x != nil {
		return x.SoloJazzCost
	}
	return 0
}

func (x *RegistrationPricesRes) GetTeamCompetitionCost() int64 {
	if x != nil {
		return x.TeamCompetitionCost
	}
	return 0
}

func (x *RegistrationPricesRes) GetTshirtCost() int64 {
	if x != nil {
		return x.TshirtCost
	}
	return 0
