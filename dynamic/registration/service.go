...
func NewService(active, useMailSandbox bool, logger *logrus.Logger, client *square.Client, squareData *common.SquareData, authorizer Authorizer, store Store, mailClient MailClient, permissionConfig *PermissionConfig) *Service {
	return &Service{
		active:           active,
